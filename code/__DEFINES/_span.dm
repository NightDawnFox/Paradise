...
#define span_sans_alt(str) ("<span class='sans'>" + str + "</span>")
...
#define span_alert_alt(str) ("<span class='alert'>" + str + "</span>")
#define span_ghostalert(str) ("<span class='ghostalert'>[str]</span>")
#define span_warning(str) ("<span class='warning'>[str]</span>")
#define span_warning_alt(str) ("<span class='warning'>" + str + "</span>")
...
#define span_userdanger_alt(str) ("<span class='userdanger'>" + str + "</span>")
...
#define span_boldannounceic_alt(str) ("<span class='boldannounceic'>" + str + "</span>")
...
#define span_noticealien_alt(str) ("<span class='noticealien'>" + str + "</span>")
...
#define span_sinister_alt(str) ("<span class='sinister'>" + str + "</span>")
#define span_blob(str) ("<span class='blob'>[str]</span>")
#define span_revennotice(str) ("<span class='revennotice'>[str]</span>")
#define span_revennotice_alt(str) ("<span class='revennotice'>" + str + "</span>")
...
#define span_cultlarge_alt(str) ("<span class='cultlarge'>" + str + "</span>")
...
#define span_colossus_alt(str) ("<span class='colossus'>" + str + "</span>")
...
#define span_fontsize5_alt(str) ("<span style='font-size: 24px;'>" + str + "</span>")
