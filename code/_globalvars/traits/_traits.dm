...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_BEAST_EMPATHY" = TRAIT_BEAST_EMPATHY, // Похуй потом Добавить приматам
		"TRAIT_BEING_OFFERED" = TRAIT_BEING_OFFERED,
		"TRAIT_BLIND" = TRAIT_BLIND,
		"TRAIT_BLOB_ALLY" = TRAIT_BLOB_ALLY,
		"TRAIT_BLOB_WAS_BURSTED" = TRAIT_BLOB_WAS_BURSTED,
		...
		"TRAIT_IGNORE_FRACTURE" = TRAIT_IGNORE_FRACTURE,
		...
		"TRAIT_WOUND_LICKER" = TRAIT_WOUND_LICKER, // Сомнительно, Похуй потом
	...
	/obj/item = list(
		...
		"TRAIT_GIVE_READY" = TRAIT_GIVE_READY,
