...
/datum/roboquest/proc/generate_flavour()
	var/list/working = list("Поступил заказ от правительства колонии [pick("Гаусс", "Кита Эпсилон", "Тартессос")] на приобретение стандартного экзокостюма типа [name]. Запрошенные спецификации вы можете увидеть на консоли.",
		...
		"Отделом исследований и разработок на ИКН [pick("Луна", "Герцог", "Икар", "Хранитель")] был запрошен стандартный экзокостюм класса [name]. Выполение заказа в краткие сроки будет способствовать развитию науки!",
		"В связи с аварией, произошедшей на борту [pick("ИСН \"Рубикон\"", "ИСН \"Орион\"", "ИСН \"Исход\"", "АСН \" Серп \"")] на ближайшую к ней станцию был отправлен заказ на создание экзокостюма типа [name].",
		...
		"На связи ваши коллеги из Einstein Engines. У нас образовалась нехватка экзачей после того, как наше транспортное судно пропало недалеко от вашей станции, так что нам нужна срочная замена. Необходим [name]. Организуете нам одного? Платим хорошо.",
		...
		"Официальный заказ Республики Элизиум. Требования для удовлетворения условий контракта - доставка экзокостюма типа [name]. По завершении заказа и выполнении дополнительных требований награда будет повышена.",
	...
	var/list/medical = list("Корпорация Vey-med производит ревизию своих лицензированных экзокостюмов. Согласно договору об аренде экзокостюмов типа [name] вы обязаны отослать один из образцов для сверки с контрольной группой. Оплату расходов берет на себя ваша корпорация.",
		"Поступил срочный заказ от ИКН [pick("Луна", "Герцог", "Икар", "Хранитель")]. В ходе проведения эксперимента по ОТРЕДАКТИРОВАНО произошёл инцидент, приведший к различным травмам более чем у [rand(2-50)] человек. Для облечения работы медицинских отрядов был оставлен срочный заказ на [name].",
		"В связи с аварией, произошедшей на борту [pick("ИСН \"Рубикон\"", "ИСН \"Орион\"", "ИСН \"Исход\"", "АСН \" Серп \"")] на ближайшую к ней станцию был отправлен заказ на создание экзокостюма типа [name].",
		"ВНИМАНИЕ. ПРОИЗОШЛА ВСПЫШКА БИОЛОГИЧЕСКОЙ УГРОЗЫ УРОВНЯ 7 НА БОРТУ [pick("ИСН \"Рубикон\"", "ИСН \"Орион\"", "ИСН \"Исход\"", "АСН \" Серп \"")]. ДЛЯ ПОДДЕРЖАНИЯ КАРАНТИНА БЫЛ ОСТАВЛЕН ЗАПРОС НА ДОСТАВКУ ЭКЗОКОСТЮМА ТИПА [name].",
